...
# Directory ownership without recursion
[ "$(stat -c %u /opt/viaduct-shallow)" = "1500" ] || fail "shallow dir has wrong owner"
[ "$(stat -c %u /opt/viaduct-shallow/owned)" = "0" ] || fail "shallow dir chowned its contents"
